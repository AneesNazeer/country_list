    ...
    return (
        <div className='row' style={{ 'height': '100dvh' }}>
                        ...
                        <div className='row gy-3' style={{ 'maxWidth': '320px' }}>
                            ...
                            <div className='col-12'>
                                <div className='d-flex d-md-block justify-content-center mb-2'>
                                    <span style={{ 'fontWeight': 'bold' }}>New User? <a href='/' style={{ 'textDecoration': 'none' }}>Create an account</a></span>
                                </div>
                            </div>
                            <div className='col-12'>
                            ...
                            <div className='col-12'>
                                <center><span className="divider-line" >Or Sign In With</span></center>
                            </div>
                            <div className='col-12'>
            ...
            <div className='col-12 col-md-6 d-none d-md-block'>
                <div className='d-flex justify-content-center align-items-center' style={{ 'height': '100%' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="277.763" height="412" viewBox="0 0 277.763 412">
